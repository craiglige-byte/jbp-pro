...
const DEMO_DATA: JBPData = {
  ...
  "objectives": [
    {
      "id": "obj_1", "title": "实现销售目标",
      "targetValue": "为共同扩大市场份额，我司承诺在元气森林2027财年（2026年12月1日至2027年11月30日）内，通过全渠道精细化运营，达成终端市场 Sell-out 销售目标 650 万元（约合 144,444 箱），并提升核心单品在辖区的渗透率。",
      "strategies": [
        {
